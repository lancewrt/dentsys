...
const EditUserModal = ({ open, close, user, onUserUpdated }) => {
    ...
    useEffect(() => {
        if (open && user) {
            axios
                .get(`https://apidentsys.tuplrc-cla.com/api2/${user}/?action=getUserData`)
                .then((response) => {
    ...
    const handleSave = () => {
        ...
        setLoading(true);
        axios
            .put(`https://apidentsys.tuplrc-cla.com/api2/${user}/?action=updateUserData`, userData)
            .then((response) => {
    ...
    const handleStatusToggle = () => {
        ...
        axios
            .put(`https://apidentsys.tuplrc-cla.com/api2/${user}/?action=updateStatus`, { status: newStatus })
            .then((response) => {
