...
const UpdateInvoice = () => {
    ...
    const getTotalPaid = async ()=> {
        try {
            const response = await axios.get(`https://apidentsys.tuplrc-cla.com/api2/${id}/?action=getTotalPaid`);
    ...
    const handleClick = async () => {
        if(submitForm === false){
            ...
            await axios.post("https://apidentsys.tuplrc-cla.com/api2/", payment).finally(() => setLoading(false));;
    ...
    const getInvoiceDetails = async()=> {
        try {
            const response = await axios.get(`https://apidentsys.tuplrc-cla.com/api2/${id}/?action=getInvoiceDetails`);
            console.log('Full API response:', response);
    ...
    const getPayment = async()=> {
        try {
            const response = await axios.get(`https://apidentsys.tuplrc-cla.com/api2/${id}/?action=getPayment`);
            console.log('Full API response:', response);
            console.log('API response data:', response.data);
