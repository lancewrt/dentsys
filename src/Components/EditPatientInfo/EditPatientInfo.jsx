...
const EditPatientInfo = () => {
    ...
    const getPatient = ()=> {
        axios.get(`https://apidentsys.tuplrc-cla.com/api2/${id}/?action=getPatient`)
    ...
    const handleClick = async (e) => {
        ...
        if(submitForm===false){
            ...
            setLoading(true);
            try {
            await axios.put(`https://apidentsys.tuplrc-cla.com/api2/${id}/?action=editPatient`, patient).finally(() => setLoading(false));
